...
| Change type | Version | Description                              |
|:------------|:--------|:-----------------------------------------|
| Addition      | beta   | Additional Properties for [users](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/resources/user): faxNumber, onPremisesDistinguishedName, otherMails |
| Addition| beta | transitiveMembers and transitiveMemberOf call on DirectoryObjects (user, groups, servicePrincipal)
